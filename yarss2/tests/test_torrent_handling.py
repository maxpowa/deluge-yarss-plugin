...
from yarss2.common import GeneralSubsConf, read_file
...
class TorrentHandlingTestCase(unittest.TestCase):
    ...
    def test_add_torrent(self):
        ...
        filename = yarss2.common.get_resource("FreeBSD-9.0-RELEASE-amd64-dvd1.torrent", path="tests/data/")
        cookie_header = {}
        torrent_download = handler.add_torrent(filename, cookie_header, subscription_data=None)
        ...
        self.assertEquals(torrent_download.torrent_url, filename)

    def test_add_torrent_magnet_link(self):
        handler = TorrentHandler(self.log)
        torrent_url = "magnet:blbalba/url.magnet.link"
        cookie_header = {}
        self.assertTrue(handler.add_torrent(torrent_url, cookie_header, subscription_data=None))
    ...
    def test_add_torrent_ret_false(self):
        ...
        torrent_download = handler.add_torrent(torrent_url, cookies_dict, subscription_data=None)
    ...
    def test_add_torrent_with_subscription_data(self):
        ...
        handler.download_torrent_file = test_component.download_torrent_file
        d = handler.add_torrent(torrent_url, cookie_header, subscription_data=subscription_data)
    ...
    def test_add_torrents(self):
        ...
        matching_torrents = matche_result["matching_torrents"]
