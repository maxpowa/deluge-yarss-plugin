...
class DialogSubscription(object):
    ...
    def setup(self):
        ...
        self.dialog = self.glade.get_object("dialog_subscription")
...
########################################
    ...
    def setup_labels(self):
        combobox_labels = self.glade.get_object("combobox_labels")
        label_labels = self.glade.get_object("labels_label")
    ...
    def setup_move_completed_combobox(self):
        move_completed_box = self.glade.get_object("move_completed_box")
    ...
    def setup_download_location_combobox(self):
        download_location_box = self.glade.get_object("download_location_box")
    ...
    def setup_rssfeed_combobox(self):
        rssfeeds_combobox = self.glade.get_object("combobox_rssfeeds")
    ...
    def setup_messages_combobox(self):
        messages_combobox = self.glade.get_object("combobox_messages")
    ...
    def set_custom_text_tooltip(self):
        textview = self.glade.get_object("textview_custom_text")
    ...
    def add_torrent(self, torrent_link, subscription_data):
        ...
        def add_torrent_callback(torrent_download):
            ...
            textview = self.glade.get_object("textview_messages")
            ...
            notebook = self.glade.get_object("notebook_lower")
            notebook.set_current_page(1)

            # Quick hack to make sure the message is visible to the user.
            hpaned = self.glade.get_object("hpaned_matching")
    ...
    def setup_messages_list(self):
        ...
        viewport = self.glade.get_object("viewport_email_notifications")
...
###############
    ...
    def get_search_settings(self):
        regex_include = self.glade.get_object("txt_regex_include").get_text()
        regex_exclude = self.glade.get_object("txt_regex_exclude").get_text()
        regex_include_case = self.glade.get_object("regex_include_case").get_active()
        regex_exclude_case = self.glade.get_object("regex_exclude_case").get_active()
        match_option_dict = {}
...
# Perform matching and update liststore (which updates GUI)
    ...
    def perform_matching_and_update_liststore(self, match_option_dict):
        ...
        try:
            ...
            label_status = self.glade.get_object("label_status")
            if message:
                label_status.set_text(str(message))
            label_count = self.glade.get_object("label_torrent_count")
    ...
    def set_matching_window_child(self, widget):
        ...
        matching_window = self.glade.get_object("matching_window_upper")
...
###################
    ...
    def on_button_last_matched_reset_clicked(self, button):
        self.glade.get_object("txt_last_matched").set_text("")
...
###################
    ...
    def store_subscription_data(self):
        name = self.glade.get_object("txt_name").get_text()
        regex_include = self.glade.get_object("txt_regex_include").get_text()
        regex_exclude = self.glade.get_object("txt_regex_exclude").get_text()
        regex_include_case_sensitive = self.glade.get_object("regex_include_case").get_active()
        regex_exclude_case_sensitive = self.glade.get_object("regex_exclude_case").get_active()
        move_completed = ""
        ...
        last_match = self.glade.get_object("txt_last_matched").get_text()
        ignore_timestamp = self.glade.get_object("checkbutton_ignore_timestamp").get_active()

        max_download_speed = self.glade.get_object("spinbutton_max_download_speed").get_value()
        max_upload_speed = self.glade.get_object("spinbutton_max_upload_speed").get_value()
        max_connections = self.glade.get_object("spinbutton_max_connections").get_value()
        max_upload_slots = self.glade.get_object("spinbutton_max_upload_slots").get_value()

        add_torrents_paused = self.glade.get_object("checkbox_add_torrents_in_paused_state").get_active()
        auto_managed = self.glade.get_object("checkbutton_auto_managed").get_active()
        sequential_download = self.glade.get_object("checkbutton_sequential_download").get_active()
        prioritize_first_last = self.glade.get_object("checkbutton_prioritize_first_last").get_active()

        add_torrents_paused_default = self.glade.get_object(
            "checkbox_add_torrents_in_paused_state_default").get_active()
        auto_managed_default = self.glade.get_object("checkbutton_auto_managed_default").get_active()
        sequential_download_default = self.glade.get_object("checkbutton_sequential_download_default").get_active()
        prioritize_first_last_default = self.glade.get_object("checkbutton_prioritize_first_last_default").get_active()
...
########################################
    ...
    def load_basic_fields_data(self):
        if self.subscription_data is None:
            return
        self.glade.get_object("txt_name").set_text(self.subscription_data["name"])
        self.glade.get_object("txt_regex_include").set_text(self.subscription_data["regex_include"])
        self.glade.get_object("txt_regex_exclude").set_text(self.subscription_data["regex_exclude"])
        self.glade.get_object("regex_include_case").set_active(
            not self.subscription_data["regex_include_ignorecase"])
        self.glade.get_object("regex_exclude_case").set_active(
            not self.subscription_data["regex_exclude_ignorecase"])

        textbuffer = self.glade.get_object("textview_custom_text").get_buffer()
        textbuffer.set_text(self.subscription_data["custom_text_lines"])

        self.glade.get_object("spinbutton_max_download_speed").set_value(self.subscription_data["max_download_speed"])
        self.glade.get_object("spinbutton_max_upload_speed").set_value(self.subscription_data["max_upload_speed"])
        self.glade.get_object("spinbutton_max_connections").set_value(self.subscription_data["max_connections"])
        self.glade.get_object("spinbutton_max_upload_slots").set_value(self.subscription_data["max_upload_slots"])
        ...
        self.glade.get_object("checkbox_add_torrents_in_paused_state").set_active(
            add_paused == GeneralSubsConf.ENABLED)
        self.glade.get_object("checkbutton_auto_managed").set_active(
            auto_managed == GeneralSubsConf.ENABLED)
        self.glade.get_object("checkbutton_sequential_download").set_active(
            sequential_download == GeneralSubsConf.ENABLED)
        self.glade.get_object("checkbutton_prioritize_first_last").set_active(
            prioritize_first_last_pieces == GeneralSubsConf.ENABLED)

        self.glade.get_object("checkbox_add_torrents_in_paused_state_default").set_active(
            add_paused == GeneralSubsConf.DEFAULT)
        self.glade.get_object("checkbutton_auto_managed_default").set_active(
            auto_managed == GeneralSubsConf.DEFAULT)
        self.glade.get_object("checkbutton_sequential_download_default").set_active(
            sequential_download == GeneralSubsConf.DEFAULT)
        self.glade.get_object("checkbutton_prioritize_first_last_default").set_active(
    ...
    def on_general_checkbox_toggled(self, button):
        self.glade.get_object("checkbox_add_torrents_in_paused_state").set_sensitive(
            not self.glade.get_object("checkbox_add_torrents_in_paused_state_default").get_active())
        self.glade.get_object("checkbutton_auto_managed").set_sensitive(
            not self.glade.get_object("checkbutton_auto_managed_default").get_active())
        self.glade.get_object("checkbutton_sequential_download").set_sensitive(
            not self.glade.get_object("checkbutton_sequential_download_default").get_active())
        self.glade.get_object("checkbutton_prioritize_first_last").set_sensitive(
            not self.glade.get_object("checkbutton_prioritize_first_last_default").get_active())
    ...
    def load_rssfeed_combobox_data(self):
        ...
        for key in sorted(self.rssfeeds):
            ...
            count += 1
        # Set active index
        self.glade.get_object("combobox_rssfeeds").set_active(active_index)
        # Update matching
    ...
    def load_timestamp(self):
        self.glade.get_object("txt_last_matched").set_text(self.subscription_data["last_match"])
        self.glade.get_object("checkbutton_ignore_timestamp").set_active(self.subscription_data["ignore_timestamp"])
